...
function PasswordSetup() {
  ...
  return <Shell><section className="auth-page"><form className="panel auth-card" onSubmit={submit}><h1>Atur kata sandi</h1><p>Gunakan minimal 8 karakter.</p><Notice value={notice} /><label>Kata sandi baru<input required minLength="8" type="password" value={password} onChange={(e) => setPassword(e.target.value)} /></label><label>Ulangi kata sandi<input required minLength="8" type="password" value={confirm} onChange={(e) => setConfirm(e.target.value)} /></label><button className="button">Simpan</button></form></section></Shell>;
}

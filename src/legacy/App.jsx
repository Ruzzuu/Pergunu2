  ...
  return (
    <NewsImageProvider>
      <Routes>
        ...
        <Route path="/atur-password" element={<PasswordSetup />} />
        <Route path="/lupa-password" element={<PasswordSetup request />} />
        <Route path="/admin" element={<SessionGate admin><PendingApplicationsProvider><AdminDashboard /></PendingApplicationsProvider></SessionGate>} />
        <Route path="/user-dashboard" element={<SessionGate><UserDashboard /></SessionGate>} />
      </Routes>
    </NewsImageProvider>
  );
};

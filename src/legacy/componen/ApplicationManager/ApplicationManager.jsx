...
const ApplicationManager = ({ onPendingCountChange, onUsersChanged }) => {
  ...
  const handleApprove = async (application) => {
    try {
      ...
      const { application: updatedApp } = await ApplicationService.approveAndRegister(application);
  ...
  // User feedback with final username
      alert(updatedApp.invitationSent ? 'Pendaftaran disetujui. Tautan pengaturan password telah dikirim.' : 'Pendaftaran disetujui dan akun tersimpan. Email undangan belum terkirim; kirim ulang melalui Edit pengguna setelah layanan email siap.');
